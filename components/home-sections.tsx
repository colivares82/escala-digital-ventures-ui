...
export function ProblemSection({ content }: { content:typeof homeContent.problem }) {
 return <section className="section section--light" id="problema"><div className="page-shell"><SectionIndex index="01" label="PUNTO DE PARTIDA"/><div className="split-heading"><WordReveal text={content.title}/><Reveal><p className="lead-copy">{content.body}</p></Reveal></div><SystemDiagram kind="problem" label="Flujo operativo fragmentado entre hojas, correos y documentos"/></div></section>
}
