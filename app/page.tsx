  ...
  return (
    <MotionRuntime>
      <a className="skip-link" href="#contenido">
        {sharedContent.accessibility.skipToContent}
      </a>
      <SiteHeader content={homeContent.header} />
      <main id="contenido">
        <Hero content={homeContent.hero} claims={homeContent.claims} />
        <ProblemSection content={homeContent.problem} />
        <ServicesPreview content={homeContent.services} />
        <FrameworkSection content={homeContent.framework} />
        <ProofSection content={homeContent.proof} />
        <AllianceTeaser content={homeContent.alliance} />
