...
01 **Punto de partida** (paper) — H2 "Tu negocio funciona. Tus sistemas, no."; mono symptom list (VOLUMEN QUE CRECE · ERRORES QUE SE MULTIPLICAN · FACTURACIÓN QUE SE RETRASA · DEPENDENCIA DE PERSONAS) with dashed ticks, staggered reveal; paragraph right (Libro Ch. 10); FIG. 02 below-right.
